...
export default class SlideTocV extends Vue {
    ...
    mounted(): void {
        ...
        this.content =
            this.element[this.lang]?.title ||
            (this.element[this.lang]?.title === ''
                ? this.lang === 'en'
                    ? this.$t('editor.slides.toc.newENGSlideText')
                    : this.$t('editor.slides.toc.newFRSlideText')
                : this.lang === 'en'
                ? this.$t('editor.slides.toc.noENGslide')
                : this.$t('editor.slides.toc.noFRslide'));
    }
...
.truncate-multiline {
    ...
    text-overflow: ellipsis; /* Optional: Adds "..." at the end of the truncated content */
