    ...
    actions: {
        ...
        handleSessionTimeout(): void {
            ...
            lockStore.confirmationTimeout = setTimeout(() => {
                ...
                vfm.open(`confirm-extend-session-editor`); // TODO: find way to access modal. maybe create a state variable that we toggle depending on if we want to open or close it
