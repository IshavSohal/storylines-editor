...
.centerSlideRight {\n\ttext-align: right;\n}\n\n.centerSlideFull {\n\ttext-align: center;\n}\n\n`;
        ...
        async configFileStructureHelper(configZip: typeof JSZip, uploadFiles?: Array<File | undefined>): Promise<void> {
            console.log(' ');
            console.log('configFileStructureHelper()');
            return new Promise((resolve, reject) => {
                const editorStore = useEditorStore();
                ...
                this.createMainStyles(configZip)
                    .then(() => {
                        ...
                        return editorStore.correctUuid();
                    })
                    .then(resolve)
                    .catch(reject);
            });
        ...
        onSaveFinish(): void {
            ...
            setTimeout(() => {
                ...
                if (editorStore.sessionExpired) {
                    console.log('going to home expired');
                    this.clearData();
        ...
        generateRemoteConfig(): Promise<void> {
            console.log(' ');
            console.log('generateRemoteConfig()');
            console.log('uuid');
        ...
        async uploadAsset(asset: File, config: StoryRampConfig, type: 'logo' | 'backgroundImage'): Promise<void> {
            ...
            if (type === 'backgroundImage') {
                if (config.introSlide.backgroundImage !== uploadSource) {
                    ...
                    console.log(`productStore -> uploadAsset()`, this.sourceCounts);
                }
            } else {
